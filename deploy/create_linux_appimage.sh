...
QGC_CUSTOM_APP_NAME="${QGC_CUSTOM_APP_NAME:-CustomQGC}"
QGC_CUSTOM_GENERIC_NAME="${QGC_CUSTOM_GENERIC_NAME:-CustomQGC}"
QGC_CUSTOM_BINARY_NAME="${QGC_CUSTOM_BINARY_NAME:-CustomQGC}"
...
QGC_CUSTOM_APP_ICON_NAME="${QGC_CUSTOM_APP_ICON_NAME:-CustomQGC}"
...
echo "${QGC_RELEASE_DIR}/${QGC_CUSTOM_BINARY_NAME} "
