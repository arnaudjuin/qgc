            ...
            QGCSlider {
                ...
                onValueChanged: {
                    ...
                    switch (gridSlider.value) {
                        case 6:
                            if (vazaoSlider.value === 1) pwmValue = 1300;
                            else if (vazaoSlider.value === 2) pwmValue = 1325;
                            else if (vazaoSlider.value === 3) pwmValue = 1350;
                            break;
                        case 8:
                            if (vazaoSlider.value === 1) pwmValue = 1300;
                            else if (vazaoSlider.value === 2) pwmValue = 1350;
                            else if (vazaoSlider.value === 3) pwmValue = 1400;
                            break;
                        case 10:
                            if (vazaoSlider.value === 1) pwmValue = 1300;
                            else if (vazaoSlider.value === 2) pwmValue = 1400;
                            else if (vazaoSlider.value === 3) pwmValue = 1450;
                            break;
                        case 12:
                            if (vazaoSlider.value === 1) pwmValue = 1325;
                            else if (vazaoSlider.value === 2) pwmValue = 1400;
                            else if (vazaoSlider.value === 3) pwmValue = 1500;
                            break;
                    }
            ...
            RowLayout {
                ...
                QGCButton {
                    ...
                    onClicked: {
                        var pwmValue = 1200;
                        selectedButton = 0;
                        velocidade = 1; // Define a velocidade para 1 m/s
                ...
                QGCButton {
                    ...
                    onClicked: {
                        ...
                        // Define a velocidade no MissionController
                        if (_missionController) {
