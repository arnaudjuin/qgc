...
DECLARE_SETTINGSFACT(AppSettings, offlineEditingSprayerFlow)
DECLARE_SETTINGSFACT(AppSettings, offlineEditingAltitude)
DECLARE_SETTINGSFACT(AppSettings, offlineEditingSprayerHeight)
DECLARE_SETTINGSFACT(AppSettings, offlineEditingSpacing)
DECLARE_SETTINGSFACT(AppSettings, offlineEditingSprayerVolume)
