...
public:
    ...
    QString         commandDescription          (void) const final { return tr("Parâmetros da missão1"); }
    QString         commandName                 (void) const final { return tr("Configurações da Missão"); } //Nome dos parâmetros
