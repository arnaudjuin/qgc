...
protected:
    ...
    void    _appendStartSpray               (QList<MissionItem*>& items, QObject* missionItemParent, int& seqNum);
    void    _appendStopSpray                (QList<MissionItem*>& items, QObject* missionItemParent, int& seqNum);
